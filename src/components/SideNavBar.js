      ...
      <div className="p-3 sidenav">
        <ul className="nav flex-column sidebar-menu">
          ...
          {adminOpen && (
            <>
              <li className="nav-item">
                <Link className="nav-link" to="/strategy-description" onClick={onClose}>
                  Strategy Description
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="/kpi-management" onClick={onClose}>
                  KPI Management
                </Link>
              </li>
            </>
          ...
          {systemOpen && (
            <>
              <li className="nav-item">
                <Link className="nav-link" to="/manage-users" onClick={onClose}>
                  Manage Users
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="/perspective-strategy" onClick={onClose}>
                  Perspective and Strategy
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="/department-tolerance" onClick={onClose}>
